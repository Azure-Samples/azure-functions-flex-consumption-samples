...
output SERVICE_PROCESSOR_IDENTITY_PRINCIPAL_ID string = api.outputs.identityPrincipalId
output SERVICE_PROCESSOR_NAME string = api.outputs.name
output SERVICE_PROCESSOR_URI string = api.outputs.uri
