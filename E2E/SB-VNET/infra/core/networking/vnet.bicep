...
output bastionSubnetName string = useVM ? virtualNetwork.properties.subnets[2].name : ''
output bastionSubnetID string =  useVM ? virtualNetwork.properties.subnets[2].id : ''
output vmSubnetName string =  useVM ? virtualNetwork.properties.subnets[3].name : ''
output vmSubnetID string =  useVM ? virtualNetwork.properties.subnets[3].id : ''
